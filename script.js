...
// Verifica si hay un posible escalera con un includes() ordenando los resultados primero con un Sort(),
// luego los resultados 1 x 1 ingresan en un nuevo array usando .join()
...
const detectFullHouse = (arr) => {
  ...
  // remember Object.values create an array with only counts and includes verify if that number is inside
